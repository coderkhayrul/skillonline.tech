    ...
    <div class="main-swiper">
        <div class="swiper-wrapper">
            <div class="swiper-slide bg-blue"
                style="background-image: url({{ asset('frontend') }}/images/background/waveelement.png);">
                <div class="container">
                    <div class="banner-content">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="swiper-content">
                                    <div class="content-info">
                                        ...
                                        <h1 class="title mb-0" data-swiper-parallax="-20">Think and Grow
                                            Rich</h1>
                                        ...
                                        <p class="text mb-0" data-swiper-parallax="-40">It is a long
                                        ...
                                        <div class="content-btn" data-swiper-parallax="-60">
                                            <a class="btn btn-primary btnhover"
                                                href="books-grid-view.html">See Details</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="partner">
                                        ...
                                        <div class="brand-logo">
                                            ...
                                            <img class="mid-logo" src="{{ asset('frontend') }}/images/partner/partner-2.png"
                                                alt="client">
                            ...
                            <div class="col-md-6">
                                ...
                                <img class="pattern" src="{{ asset('frontend') }}/images/Group.png" data-swiper-parallax="-100"
                                    alt="dots">
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="banner-content">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="swiper-content">
                                    <div class="content-info">
                                        ...
                                        <h1 class="title mb-0" data-swiper-parallax="-20">Pushing Clouds
                                        </h1>
                                        <ul class="dz-tags" data-swiper-parallax="-30">
                                            <li><a href="javascript:void(0);">Napoleon Hill</a></li>
                                            <li><a href="javascript:void(0);">Business & Strategy</a></li>
                                        </ul>
                                        <p class="text mb-0" data-swiper-parallax="-40">Lorem ipsum dolor
                                        ...
                                        <div class="content-btn" data-swiper-parallax="-50">
                                            <a class="btn btn-primary btnhover" href="#">See Details</a>
                                        </div>
                                    </div>
                                    <div class="partner">
                                        <p>Our partner</p>
                            ...
                            <div class="col-md-6">
                                <div class="banner-media" data-swiper-parallax="-100">
                                    <img src="{{ asset('frontend') }}/images/banner/banner-media2.png" alt="banner-media1">
                                </div>
                                <img class="pattern" src="{{ asset('frontend') }}/images/Group.png" data-swiper-parallax="-100"
                                    alt="dots">
                            </div>
